...
outfile_BP_EdGuess = f"temp_results_LTFIM/fileBP_EpsRand_{indexr}_LTFIM_L={L}_P={P}_g={g}_h={h}_eps={eps_opt}_ans={ans}_OnlyZZ={onlyZZ}_sign={sign}.npz"
#
...
parOtt=np.random.rand(prep*P)*np.pi*2  # Python indexing
