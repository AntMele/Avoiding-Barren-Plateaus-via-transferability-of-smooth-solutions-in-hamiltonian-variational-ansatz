...
python main_BP_LTFIM_ed_Newstartrand.py $randd $g $h $nrands ${Linp[$SLURM_ARRAY_TASK_ID]} $lg $epsopt $P $Pmaxguess $iterguess $ans $onlyZZ $sign ${ArrR[$SLURM_ARRAY_TASK_ID]}
