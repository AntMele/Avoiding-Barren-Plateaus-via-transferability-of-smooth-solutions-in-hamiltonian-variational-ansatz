...
outfile_BP_EdGuess = f"temp_results_XYZ/fileBP_EpsRand_{indexr}_XYZ_L={L}_P={P}_deltaY={deltaY}_deltaZ={deltaZ}_eps={eps_opt}.npz"
...
parOtt=np.random.rand(2*P)*np.pi/2 # Python indexing
