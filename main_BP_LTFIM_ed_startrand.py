...
if (run_educ_BP==1):
    ...
    ##### 2) BP educated guess
    outfile_BP_EdGuess =f"temp_results_LTFIM/fileBP_EdGuessRand_LTFIM_L={L}_P={P}_g={g}_h={h}_{ans}_Lguess={Lguess}_eps={eps_opt}_OnlyZZ={onlyZZ}_sign={sign}.npz"
    #
    # file with VQE results for Lguess 
    EdGuess_file = f"temp_results_LTFIM/file_Opt_StartRand_LTFIM_g={g}_h={h}_{ans}_L={Lguess}_P={Pmaxguess}_maxiter={iterguess}_sign={sign}.npz"
    ...
    parOtt=optparlist[0] #c'è selo un valore di P dentro il vettore Python indexing
